...
func TestIdP1RegisterIdentityWithInvalidNamespace(t *testing.T) {
	h := sha256.New()
	h.Write([]byte("Inlavid Namespace" + userID1))
	userHash := h.Sum(nil)
	var user did.RegisterIdentityParam
	user.ReferenceGroupCode = referenceGroupCode1.String()
	var identity did.Identity
	...
	user.RequestID = requestID1.String()
	var param = user
	RegisterIdentity(t, param, idpPrivK, IdP1, "Namespace is invalid")
}
...
func TestQueryGetIdpNodes1ByIdentity(t *testing.T) {
	...
	param.MinIal = 3
	param.MinAal = 3
	var expected = `{"node":[{"node_id":"` + IdP1 + `","node_name":"IdP Number 1","max_ial":3,"max_aal":3,"mode_list":[2],"supported_request_message_data_url_type_list":[]}]}`
	GetIdpNodesExpectString(t, param, expected)
}
...
func TestQueryGetIdpNodes1ByIdentity2(t *testing.T) {
	...
	param.MinIal = 2.3
	param.MinAal = 3
	var expected = `{"node":[{"node_id":"` + IdP1 + `","node_name":"IdP Number 1","max_ial":3,"max_aal":3,"mode_list":[2],"supported_request_message_data_url_type_list":[]},{"node_id":"` + IdP2 + `","node_name":"IdP Number 2","max_ial":2.3,"max_aal":3,"mode_list":[2],"supported_request_message_data_url_type_list":[]}]}`
	GetIdpNodesExpectString(t, param, expected)
}
...
func TestIdP2RegisterIdentityToExistedRefGroupAgain(t *testing.T) {
	...
	user.Ial = 2.3
	user.ModeList = append(user.ModeList, 2)
	user.ModeList = append(user.ModeList, 3)
	user.AccessorID = accessorID2.String()
	user.AccessorPublicKey = accessorPubKey2
	user.AccessorType = "RSA2048"
...
func TestQueryGetNodeInfoBeforeUpdateNode(t *testing.T) {
...
func TestQueryGetNodeInfoAfterUpdateNode(t *testing.T) {
	var param did.GetNodeInfoParam
	param.NodeID = IdP1
...
func TestQueryGetIdpNodesInfoWithSupportedRequestMessageDataUrlTypeListFilter(t *testing.T) {
	var param did.GetIdpNodesParam
	param.ReferenceGroupCode = referenceGroupCode1.String()
	param.MinIal = 2.3
	param.MinAal = 3
...
func TestIdP2RevokeAndAddAccessor(t *testing.T) {
	...
	param.RevokingAccessorID = accessorID2.String()
