...
func TestQueryGetIdpNodesForMode1(t *testing.T) {
	...
	param.MinIal = 3
	param.MinAal = 3
	var expected = `{"node":[{"node_id":"` + IdP1 + `","node_name":"IdP Number 1","max_ial":3,"max_aal":3,"mode_list":[1],"supported_request_message_type_list":["text/plain"]}]}`
...
func TestQueryGetIdpNodes1ByIdentity(t *testing.T) {
	...
	param.MinIal = 3
	param.MinAal = 3
	var expected = `{"node":[{"node_id":"` + IdP1 + `","node_name":"IdP Number 1","max_ial":3,"max_aal":3,"mode_list":[2],"supported_request_message_type_list":["text/plain"]}]}`
	GetIdpNodesExpectString(t, param, expected)
}
...
func TestQueryGetIdpNodesInfoByRefGroupCode(t *testing.T) {
	...
	param.MinIal = 3
	param.MinAal = 3
	var expected = `{"node":[{"node_id":"` + IdP1 + `","name":"IdP Number 1","max_ial":3,"max_aal":3,"public_key":"-----BEGIN PUBLIC KEY-----\\njwIDAQAB\n-----END PUBLIC KEY-----\n","mq":[{"ip":"192.168.3.99","port":8000}],"mode_list":[2],"supported_request_message_type_list":["text/plain"]}]}`
	GetIdpNodesInfo(t, param, expected)
}
...
func TestQueryGetIdpNodes1ByIdentity2(t *testing.T) {
	...
	param.MinIal = 2.3
	param.MinAal = 3
	var expected = `{"node":[{"node_id":"` + IdP1 + `","node_name":"IdP Number 1","max_ial":3,"max_aal":3,"mode_list":[2],"supported_request_message_type_list":["text/plain"]},{"node_id":"` + IdP2 + `","node_name":"IdP Number 2","max_ial":2.3,"max_aal":3,"mode_list":[2],"supported_request_message_type_list":["text/plain"]}]}`
	GetIdpNodesExpectString(t, param, expected)
}
...
func TestQueryGetIdpNodesInfoByRefGroupCodeAfterRegisterIdentityAgain(t *testing.T) {
	...
	param.MinIal = 2.3
	param.MinAal = 3
	var expected = `{"node":[{"node_id":"` + IdP1 + `","name":"IdP Number 1","max_ial":3,"max_aal":3,"public_key":"-----BEGIN PUBLIC KEY-----\\njwIDAQAB\n-----END PUBLIC KEY-----\n","mq":[{"ip":"192.168.3.99","port":8000}],"mode_list":[2],"supported_request_message_type_list":["text/plain"]},{"node_id":"` + IdP2 + `","name":"IdP Number 2","max_ial":2.3,"max_aal":3,"public_key":"-----BEGIN PUBLIC KEY-----\\nPwIDAQAB\n-----END PUBLIC KEY-----\n","mq":[{"ip":"192.168.3.100","port":8000}],"mode_list":[2,3],"supported_request_message_type_list":["text/plain"]}]}`
	GetIdpNodesInfo(t, param, expected)
}
...
func TestQueryGetNodeInfoAfterUpdateNode(t *testing.T) {
	var param did.GetNodeInfoParam
	param.NodeID = IdP1
	expected := string(`{"public_key":"-----BEGIN PUBLIC KEY-----\\nPwIDAQAB\n-----END PUBLIC KEY-----\n","master_public_key":"-----BEGIN PUBLIC KEY-----\\nDQIDAQAB\n-----END PUBLIC KEY-----\n","node_name":"IdP Number 1","role":"IdP","max_ial":3,"max_aal":3,"supported_request_message_type_list":["text/plain","application/pdf"],"mq":[{"ip":"192.168.3.99","port":8000}]}`)
	GetNodeInfo(t, param, expected)
}
