...
import (
	...
	"github.com/ndidplatform/smart-contract/v5/test/as"
	"github.com/ndidplatform/smart-contract/v5/test/common"
	"github.com/ndidplatform/smart-contract/v5/test/data"
	"github.com/ndidplatform/smart-contract/v5/test/idp"
	"github.com/ndidplatform/smart-contract/v5/test/ndid"
...
func TestIdP1UpdateNode(t *testing.T) {
	query.TestGetNodeInfo(t, data.IdP1, `{"public_key":"-----BEGIN PUBLIC KEY-----\\njwIDAQAB\n-----END PUBLIC KEY-----\n","master_public_key":"-----BEGIN PUBLIC KEY-----\\nDQIDAQAB\n-----END PUBLIC KEY-----\n","node_name":"IdP Number 1","role":"IdP","max_ial":3,"max_aal":3,"supported_request_message_data_url_type_list":[],"agent":false,"node_id_whitelist_active":false,"mq":[{"ip":"192.168.3.99","port":8000}],"active":true}`)
	common.TestUpdateNode(t, 1, "success")
	query.TestGetNodeInfo(t, data.IdP1, `{"public_key":"-----BEGIN PUBLIC KEY-----\\nPwIDAQAB\n-----END PUBLIC KEY-----\n","master_public_key":"-----BEGIN PUBLIC KEY-----\\nDQIDAQAB\n-----END PUBLIC KEY-----\n","node_name":"IdP Number 1","role":"IdP","max_ial":3,"max_aal":3,"supported_request_message_data_url_type_list":["text/plain","application/pdf"],"agent":false,"node_id_whitelist_active":false,"mq":[{"ip":"192.168.3.99","port":8000}],"active":true}`)
	...
	query.TestGetNodeInfo(t, data.IdP1, `{"public_key":"-----BEGIN PUBLIC KEY-----\\njwIDAQAB\n-----END PUBLIC KEY-----\n","master_public_key":"-----BEGIN PUBLIC KEY-----\\nDQIDAQAB\n-----END PUBLIC KEY-----\n","node_name":"IdP Number 1","role":"IdP","max_ial":3,"max_aal":3,"supported_request_message_data_url_type_list":["text/plain"],"agent":false,"node_id_whitelist_active":false,"mq":[{"ip":"192.168.3.99","port":8000}],"active":true}`)
}
