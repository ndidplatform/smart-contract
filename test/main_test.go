...
import (
	...
	"github.com/ndidplatform/smart-contract/v8/test/as"
	"github.com/ndidplatform/smart-contract/v8/test/common"
	"github.com/ndidplatform/smart-contract/v8/test/data"
	"github.com/ndidplatform/smart-contract/v8/test/idp"
	"github.com/ndidplatform/smart-contract/v8/test/ndid"
	"github.com/ndidplatform/smart-contract/v8/test/query"
)
...
func TestIdP1RegisterIdentity(t *testing.T) {
	...
	query.TestGetIdpNodes(t, 1, `{"node":[{"node_id":"`+data.IdP1+`","node_name":"IdP Number 1","max_ial":3,"max_aal":3,"on_the_fly_support":false,"lial":null,"laal":null,"supported_request_message_data_url_type_list":[],"agent":false}]}`)
	query.TestGetIdpNodesInfo(t, 1, `{"node":[{"node_id":"`+data.IdP1+`","name":"IdP Number 1","max_ial":3,"max_aal":3,"on_the_fly_support":false,"public_key":"-----BEGIN PUBLIC KEY-----\\njwIDAQAB\n-----END PUBLIC KEY-----\n","mq":[{"ip":"192.168.3.99","port":8000}],"agent":false,"node_id_whitelist_active":false,"supported_request_message_data_url_type_list":[]}]}`)
	query.TestGetIdpNodes(t, 2, `{"node":[]}`)
	query.TestGetIdpNodes(t, 3, `{"node":[{"node_id":"`+data.IdP1+`","node_name":"IdP Number 1","max_ial":3,"max_aal":3,"on_the_fly_support":false,"ial":3,"lial":null,"laal":null,"mode_list":[2],"supported_request_message_data_url_type_list":[],"agent":false}]}`)
	query.TestGetIdpNodes(t, 4, `{"node":[{"node_id":"`+data.IdP1+`","node_name":"IdP Number 1","max_ial":3,"max_aal":3,"on_the_fly_support":false,"ial":3,"lial":null,"laal":null,"mode_list":[2],"supported_request_message_data_url_type_list":[],"agent":false}]}`)
	query.TestGetIdpNodesInfo(t, 2, `{"node":[{"node_id":"`+data.IdP1+`","name":"IdP Number 1","max_ial":3,"max_aal":3,"on_the_fly_support":false,"public_key":"-----BEGIN PUBLIC KEY-----\\njwIDAQAB\n-----END PUBLIC KEY-----\n","mq":[{"ip":"192.168.3.99","port":8000}],"agent":false,"node_id_whitelist_active":false,"ial":3,"mode_list":[2],"supported_request_message_data_url_type_list":[]}]}`)
...
func TestIdP2RegisterIdentity(t *testing.T) {
	...
	query.TestGetIdpNodes(t, 5, `{"node":[{"node_id":"`+data.IdP1+`","node_name":"IdP Number 1","max_ial":3,"max_aal":3,"on_the_fly_support":false,"ial":3,"lial":null,"laal":null,"mode_list":[2],"supported_request_message_data_url_type_list":[],"agent":false},{"node_id":"`+data.IdP2+`","node_name":"IdP Number 2","max_ial":2.3,"max_aal":3,"on_the_fly_support":false,"ial":2.3,"lial":null,"laal":null,"mode_list":[2],"supported_request_message_data_url_type_list":[],"agent":false}]}`)
...
func TestIdP1UpdateIdentity(t *testing.T) {
	...
	query.TestGetIdpNodesInfo(t, 3, `{"node":[{"node_id":"`+data.IdP1+`","name":"IdP Number 1","max_ial":3,"max_aal":3,"on_the_fly_support":false,"public_key":"-----BEGIN PUBLIC KEY-----\\njwIDAQAB\n-----END PUBLIC KEY-----\n","mq":[{"ip":"192.168.3.99","port":8000}],"agent":false,"node_id_whitelist_active":false,"ial":2.3,"mode_list":[2],"supported_request_message_data_url_type_list":[]},{"node_id":"`+data.IdP2+`","name":"IdP Number 2","max_ial":2.3,"max_aal":3,"on_the_fly_support":false,"public_key":"-----BEGIN PUBLIC KEY-----\\nPwIDAQAB\n-----END PUBLIC KEY-----\n","mq":[{"ip":"192.168.3.100","port":8000}],"agent":false,"node_id_whitelist_active":false,"ial":2.3,"mode_list":[2],"supported_request_message_data_url_type_list":[]}]}`)
}
...
func TestIdP2RevokeIdentityAssociation(t *testing.T) {
	...
	query.TestGetIdpNodesInfo(t, 3, `{"node":[{"node_id":"`+data.IdP1+`","name":"IdP Number 1","max_ial":3,"max_aal":3,"on_the_fly_support":false,"public_key":"-----BEGIN PUBLIC KEY-----\\njwIDAQAB\n-----END PUBLIC KEY-----\n","mq":[{"ip":"192.168.3.99","port":8000}],"agent":false,"node_id_whitelist_active":false,"ial":2.3,"mode_list":[2],"supported_request_message_data_url_type_list":[]}]}`)
}
...
func TestIdP2RegisterIdentityAfterRevokeIdentityAssociation(t *testing.T) {
	...
	query.TestGetIdpNodesInfo(t, 3, `{"node":[{"node_id":"`+data.IdP1+`","name":"IdP Number 1","max_ial":3,"max_aal":3,"on_the_fly_support":false,"public_key":"-----BEGIN PUBLIC KEY-----\\njwIDAQAB\n-----END PUBLIC KEY-----\n","mq":[{"ip":"192.168.3.99","port":8000}],"agent":false,"node_id_whitelist_active":false,"ial":2.3,"mode_list":[2],"supported_request_message_data_url_type_list":[]},{"node_id":"`+data.IdP2+`","name":"IdP Number 2","max_ial":2.3,"max_aal":3,"on_the_fly_support":false,"public_key":"-----BEGIN PUBLIC KEY-----\\nPwIDAQAB\n-----END PUBLIC KEY-----\n","mq":[{"ip":"192.168.3.100","port":8000}],"agent":false,"node_id_whitelist_active":false,"ial":2.3,"mode_list":[2,3],"supported_request_message_data_url_type_list":[]}]}`)
}
...
func TestIdP1UpdateNode(t *testing.T) {
	query.TestGetNodeInfo(t, data.IdP1, `{"public_key":"-----BEGIN PUBLIC KEY-----\\njwIDAQAB\n-----END PUBLIC KEY-----\n","master_public_key":"-----BEGIN PUBLIC KEY-----\\nDQIDAQAB\n-----END PUBLIC KEY-----\n","node_name":"IdP Number 1","role":"IdP","max_ial":3,"max_aal":3,"on_the_fly_support":false,"supported_request_message_data_url_type_list":[],"agent":false,"node_id_whitelist_active":false,"mq":[{"ip":"192.168.3.99","port":8000}],"active":true}`)
	common.TestUpdateNode(t, 1, "success", "DeliverTx")
	query.TestGetNodeInfo(t, data.IdP1, `{"public_key":"-----BEGIN PUBLIC KEY-----\\nPwIDAQAB\n-----END PUBLIC KEY-----\n","master_public_key":"-----BEGIN PUBLIC KEY-----\\nDQIDAQAB\n-----END PUBLIC KEY-----\n","node_name":"IdP Number 1","role":"IdP","max_ial":3,"max_aal":3,"on_the_fly_support":false,"supported_request_message_data_url_type_list":["text/plain","application/pdf"],"agent":false,"node_id_whitelist_active":false,"mq":[{"ip":"192.168.3.99","port":8000}],"active":true}`)
	query.TestGetIdpNodesInfo(t, 4, `{"node":[{"node_id":"`+data.IdP1+`","name":"IdP Number 1","max_ial":3,"max_aal":3,"on_the_fly_support":false,"public_key":"-----BEGIN PUBLIC KEY-----\\nPwIDAQAB\n-----END PUBLIC KEY-----\n","mq":[{"ip":"192.168.3.99","port":8000}],"agent":false,"node_id_whitelist_active":false,"ial":2.3,"mode_list":[2,3],"supported_request_message_data_url_type_list":["text/plain","application/pdf"]}]}`)
	common.TestUpdateNode(t, 2, "success", "DeliverTx")
	query.TestGetNodeInfo(t, data.IdP1, `{"public_key":"-----BEGIN PUBLIC KEY-----\\njwIDAQAB\n-----END PUBLIC KEY-----\n","master_public_key":"-----BEGIN PUBLIC KEY-----\\nDQIDAQAB\n-----END PUBLIC KEY-----\n","node_name":"IdP Number 1","role":"IdP","max_ial":3,"max_aal":3,"on_the_fly_support":false,"supported_request_message_data_url_type_list":["text/plain"],"agent":false,"node_id_whitelist_active":false,"mq":[{"ip":"192.168.3.99","port":8000}],"active":true}`)
}
