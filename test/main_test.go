...
func TestIdP1RegisterIdentity(t *testing.T) {
	...
	query.TestGetIdpNodes(t, 1, `{"node":[{"node_id":"`+data.IdP1+`","node_name":"IdP Number 1","max_ial":3,"max_aal":3,"is_idp_agent":false,"supported_request_message_data_url_type_list":[]}]}`)
	query.TestGetIdpNodesInfo(t, 1, `{"node":[{"node_id":"`+data.IdP1+`","name":"IdP Number 1","max_ial":3,"max_aal":3,"public_key":"-----BEGIN PUBLIC KEY-----\\njwIDAQAB\n-----END PUBLIC KEY-----\n","mq":[{"ip":"192.168.3.99","port":8000}],"is_idp_agent":false,"supported_request_message_data_url_type_list":[]}]}`)
	query.TestGetIdpNodes(t, 2, `{"node":[]}`)
	query.TestGetIdpNodes(t, 3, `{"node":[{"node_id":"`+data.IdP1+`","node_name":"IdP Number 1","max_ial":3,"max_aal":3,"is_idp_agent":false,"ial":3,"mode_list":[2],"supported_request_message_data_url_type_list":[]}]}`)
	query.TestGetIdpNodes(t, 4, `{"node":[{"node_id":"`+data.IdP1+`","node_name":"IdP Number 1","max_ial":3,"max_aal":3,"is_idp_agent":false,"ial":3,"mode_list":[2],"supported_request_message_data_url_type_list":[]}]}`)
	query.TestGetIdpNodesInfo(t, 2, `{"node":[{"node_id":"`+data.IdP1+`","name":"IdP Number 1","max_ial":3,"max_aal":3,"public_key":"-----BEGIN PUBLIC KEY-----\\njwIDAQAB\n-----END PUBLIC KEY-----\n","mq":[{"ip":"192.168.3.99","port":8000}],"is_idp_agent":false,"ial":3,"mode_list":[2],"supported_request_message_data_url_type_list":[]}]}`)
...
func TestIdP2RegisterIdentity(t *testing.T) {
	...
	query.TestGetIdpNodes(t, 5, `{"node":[{"node_id":"`+data.IdP1+`","node_name":"IdP Number 1","max_ial":3,"max_aal":3,"is_idp_agent":false,"ial":3,"mode_list":[2],"supported_request_message_data_url_type_list":[]},{"node_id":"`+data.IdP2+`","node_name":"IdP Number 2","max_ial":2.3,"max_aal":3,"is_idp_agent":false,"ial":2.3,"mode_list":[2],"supported_request_message_data_url_type_list":[]}]}`)
...
func TestIdP2RevokeIdentityAssociation(t *testing.T) {
	...
	query.TestGetIdpNodesInfo(t, 3, `{"node":[{"node_id":"`+data.IdP1+`","name":"IdP Number 1","max_ial":3,"max_aal":3,"public_key":"-----BEGIN PUBLIC KEY-----\\njwIDAQAB\n-----END PUBLIC KEY-----\n","mq":[{"ip":"192.168.3.99","port":8000}],"is_idp_agent":false,"ial":2.3,"mode_list":[2],"supported_request_message_data_url_type_list":[]}]}`)
}
...
func TestIdP2RegisterIdentityAfterRevokeIdentityAssociation(t *testing.T) {
	...
	query.TestGetIdpNodesInfo(t, 3, `{"node":[{"node_id":"`+data.IdP1+`","name":"IdP Number 1","max_ial":3,"max_aal":3,"public_key":"-----BEGIN PUBLIC KEY-----\\njwIDAQAB\n-----END PUBLIC KEY-----\n","mq":[{"ip":"192.168.3.99","port":8000}],"is_idp_agent":false,"ial":2.3,"mode_list":[2],"supported_request_message_data_url_type_list":[]},{"node_id":"`+data.IdP2+`","name":"IdP Number 2","max_ial":2.3,"max_aal":3,"public_key":"-----BEGIN PUBLIC KEY-----\\nPwIDAQAB\n-----END PUBLIC KEY-----\n","mq":[{"ip":"192.168.3.100","port":8000}],"is_idp_agent":false,"ial":2.3,"mode_list":[2,3],"supported_request_message_data_url_type_list":[]}]}`)
}
...
func TestIdP1UpdateNode(t *testing.T) {
	...
	query.TestGetIdpNodesInfo(t, 4, `{"node":[{"node_id":"`+data.IdP1+`","name":"IdP Number 1","max_ial":3,"max_aal":3,"public_key":"-----BEGIN PUBLIC KEY-----\\nPwIDAQAB\n-----END PUBLIC KEY-----\n","mq":[{"ip":"192.168.3.99","port":8000}],"is_idp_agent":false,"ial":2.3,"mode_list":[2,3],"supported_request_message_data_url_type_list":["text/plain","application/pdf"]}]}`)
