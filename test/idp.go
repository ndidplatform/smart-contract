...
func RevokeIdentityAssociation(t *testing.T, param did.RevokeIdentityAssociationParam, privKeyFile string, nodeID string) {
	idpKey := getPrivateKeyFromString(privKeyFile)
	idpNodeID := []byte(nodeID)
	paramJSON, err := json.Marshal(param)
	if err != nil {
...
func UpdateIdentityModeList(t *testing.T, param did.UpdateIdentityModeListParam, privKeyFile string, nodeID string) {
	idpKey := getPrivateKeyFromString(privKeyFile)
	idpNodeID := []byte(nodeID)
	paramJSON, err := json.Marshal(param)
	if err != nil {
...
func RevokeAndAddAccessor(t *testing.T, param did.RevokeAndAddAccessorParam, privKeyFile string, nodeID string, expected string) {
	idpKey := getPrivateKeyFromString(privKeyFile)
	idpNodeID := []byte(nodeID)
	paramJSON, err := json.Marshal(param)
	if err != nil {
